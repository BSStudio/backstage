...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('MEMBER_CREATED', 'MEMBER_UPDATED', 'MEMBER_ARCHIVED', 'MEMBER_REACTIVATED', 'STATUS_CHANGED', 'ROLE_ASSIGNED', 'ROLE_CHANGED', 'ROLE_REMOVED');
